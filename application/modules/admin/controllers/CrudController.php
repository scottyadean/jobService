...
class Admin_CrudController extends Zend_Controller_Action {
   ...
   public function init() {
    ...
    public function createAction() {
        ...
        if( $this->post && !empty($this->_model->onValidate) ) {
            $this->validationErrors =$this->_model->_validate($this->params);
        }
   ...
   public function deleteAction() {
    ...
    protected function _setViewParams() {
      ...
      $this->_model->onValidate = isset($c['onValidate']) ? $c['onValidate'] : null;
      $this->_model->afterInsert = isset($c['afterInsert']) ? $c['afterInsert'] : null;
      $this->_model->onDelete = isset($c['onDelete']) ? $c['onDelete'] : null;
      ...
      isset($this->form->_params) ? $this->form->_params = $this->params : "";
